...
const terms = [
  ...
  },
  {
    ...
    body: 'Messages are sent to recipients on major U.S. mobile carriers including AT&T, Verizon, T-Mobile, and others. Carriers are not liable for delayed or undelivered messages.',
  },
  {
    title: 'Privacy',
    body: 'Mobile phone numbers and opt-in data are not shared with third parties for marketing purposes. See our Privacy Policy for full details on how we handle data.',
  },
];
    ...
    <>
      <section className="pt-32 pb-16 relative hero-grid">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 right-1/4 w-[400px] h-[300px] bg-amber-500/8 rounded-full blur-[100px]" />
        </div>
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-400 text-sm">Effective Date: June 2, 2026</p>
        </div>
      </section>
          ...
          <div className="space-y-4">
            {terms.map((t) => (
              <div key={t.title} className="card p-8">
                <h2 className="font-space font-bold text-white text-lg mb-3">{t.title}</h2>
                <p className="text-gray-400 text-sm leading-relaxed">{t.body}</p>
              </div>
            ))}

            <div className="card p-8">
              <h2 className="font-space font-bold text-white text-lg mb-3">Contact Us</h2>
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                Questions about these SMS Terms? Reach out:
              </p>
              <div className="space-y-1 text-sm">
                <p className="text-gray-300 font-semibold">Schnelks Media (William Schnelker LLC)</p>
