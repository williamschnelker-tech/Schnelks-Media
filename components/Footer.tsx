...
export default function Footer() {
  return (
    <footer className="bg-paper border-t border-stone-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          {/* Brand */}
          <div className="md:col-span-2">
            <Link href="/" className="mb-4 inline-block" aria-label="Schnelks Media home">
              <Logo />
            </Link>
            <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
              Google reviews for Michigan home service companies. One friendly text after every job.
            </p>
            <div className="mt-4 space-y-2">
              <a href="tel:5178974843" className="flex items-center gap-2 text-slate-500 hover:text-slate-900 text-sm transition-colors">
                <svg className="w-4 h-4 text-pine shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
