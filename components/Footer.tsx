...
const links = {
  ...
  Services: [
    ...
    { label: 'Website Upkeep', href: '/services#upkeep' },
    { label: 'AI Automation', href: '/services#ai' },
    { label: 'Content & Drone', href: '/services#content' },
  ],
};

export default function Footer() {
  return (
    <footer className="bg-[#04091a] border-t border-amber-500/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 space-y-2">
              ...
              <a href="mailto:williamschnelker@gmail.com" className="flex items-center gap-2 text-gray-400 hover:text-white text-sm transition-colors">
                <svg className="w-4 h-4 text-blue-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-white/20 transition-all"
